(() => {
  ...
  const policy = {
    ...
    "计算口径": "Method",
    "影响值 = 趋势项 + 残差项": "Impact = trend component + residual component",
    "连续两个月相对固定基准年同月下降至少 5%，第二个月认定为政策生效":
      "A policy is considered effective in the second of two consecutive months at least 5% below the matching month in the fixed baseline year.",
    "政策作用结果": "Policy Impact Results",
    "下降": "Decrease",
    "上升": "Increase",
    "政策名称较多，可横向滚动查看全部政策。": "Scroll horizontally to view all policies.",
    "政策为行、污染物为列；点击色块可查看政策执行期的月度变化。": "Policies are shown as rows and pollutants as columns. Click a cell to view monthly changes during implementation.",
    ...
    "月度绝对变化量": "Monthly absolute change",
    "月度下降 5% 阈值（折算绝对量）": "5% monthly decline threshold (converted to an absolute value)",
    "月度下降 5% 阈值对应变化量": "Change amount corresponding to the 5% monthly decline threshold",
    "连续两月达标后生效": "Effective after two qualifying months",
    "最大下降量": "Largest decline amount",
    "结束年": "End year",
    "点击查看执行期月度变化": "Click to view monthly changes during implementation",
    "未达到": "Not reached",
    "无数据": "No data",
    "结束年较政策前基准期变化": "End-year change from the pre-policy baseline period",
    ...
    "相对固定基准年同月的绝对变化量（当月 − 基准月）": "Absolute change from the matching month in the fixed baseline year (current − baseline)",
    "绝对变化 ": "Absolute change ",
    "生效判定变化率：": "Change rate for effectiveness test: ",
    "连续两月达标，政策生效": "Policy effective after two qualifying months",
    "本月情况：": "Current month: ",
    "年同月情况：": " matching-month value: ",
    "色块比较政策开始前 12 个月平均值与结束年份平均值；2014 年开始的政策以 2014 年为初始期。":
      "Cells compare the mean of the 12 months before policy start with the mean in the final year; policies starting in 2014 use 2014 as the initial period.",
    "色块比较政策开始前 12 个月与结束年份的同期均值；结束年不足 12 个月时仅比较相同月份，2014 年开始的政策以 2014 年为初始期。":
      "Cells compare matching-month means between the 12-month pre-policy period and the final year. If the final year is incomplete, only matching months are used; policies starting in 2014 use 2014 as the initial period.",
